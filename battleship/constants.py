...
MODULE_DEFS = {
    ...
    'armor'          : {'name':'Armadura',           'w':1,'h':1,'hp':1,  'color':'armor',    'cost':80,  'rx':1,'ry':0, 'desc':'Absorve dano de colisão'},
    ...
    'radar'          : {'name':'Radar',              'w':1,'h':1,'hp':1,  'color':'research', 'cost':200, 'rx':2,'ry':1, 'desc':'+2 tiles de visão'},
